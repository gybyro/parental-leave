            ...
            {employmentType === 'Employed' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6 bg-gray-50 rounded-lg">
                    <Input 
                        ...
                        error={errors.employment?.employerName?.message as string}
                    />
                    <Input 
                        label="Employment Ratio (%)" 
                        type="number" 
                        {...register('employment.employmentRatio')} 
                        error={errors.employment?.employmentRatio?.message as string}
                    />
                </div>
            )}
            ...
            {employmentType === 'Self-employed' && (
                <div className="p-6 bg-gray-50 rounded-lg">
                    <Input 
                        ...
                        error={errors.employment?.companyName?.message as string}
                    />
                </div>
            )}
